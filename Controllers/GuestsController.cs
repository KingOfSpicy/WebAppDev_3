...
namespace CheWei_Task7Practice2.Controllers
{
    public class GuestsController : Controller
    {
        ...
        public GuestsController(CheWei_Task7Practice2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,FamilyName,Email")] Guest guest)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,FamilyName,Email")] Guest guest)
        {
            if (id != guest.Id)
            {
                return NotFound();
